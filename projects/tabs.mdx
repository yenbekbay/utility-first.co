...
We've collaborated with Tabs.ID to launch a cross-platform web and mobile app with a multiple modes that would become available depending on the type of use case. Over the course of our partnership, we've helped ship a handful of features such as business discovery, in-app payments, attachment upload, tab requests, profile switching, and multi-channel notifications.
